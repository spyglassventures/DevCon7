...
export default async function handler(req, res) {
  ...
  const customMessage = "Characterize the user based on the transactions counterparts, value and recency of trades. Then come up with interesting, yet descriptive names. Return several .eth address that suit the user and would catch his attention, making him interested in registering the name. Show atleast 3 examples. ";
